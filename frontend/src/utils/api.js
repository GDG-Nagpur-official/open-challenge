...
export const apisAPI = {
    // Enhanced GET /api/apis client to support backend query parameters
    // (search, method, status, sort_by, sort_order) for dashboard filtering,
    // sorting, and pagination. This mirrors backend capabilities and keeps
    // query construction centralized in the API layer.
